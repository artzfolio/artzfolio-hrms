...
const CACHE = 'artzfolio-hrms-v559-2026-08-11'; // v559: marker-only bump for 4-way lockstep (stale-mirror-after-write fix for Orgs/Holidays/Milestones + SalaryBands/LoyaltyBonusSettings/ExtraPay_Rules fast-reads; SW file content itself unchanged).
