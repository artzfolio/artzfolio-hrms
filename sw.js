...
const CACHE = 'artzfolio-hrms-v520-2026-08-06'; // v520: Phase 2.1b infra (Supabase JWT minting at admin login), GAS-side only, kill-switched off until SUPABASE_JWT_SECRET exists in Config. No SW/caching-shape change.
