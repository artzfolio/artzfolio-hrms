...
const CACHE = 'artzfolio-hrms-v457-2026-07-31'; // v457_recompute-datebug-slipbreakdown-timewaiver (2026-07-30): version bump for HTML/GAS/SW lockstep -- OT Claims + Bulk Bonus identity display fixes, see HTML CACHE changelog; no SW/caching-strategy change itself. // v455_identity-consistency-fix (2026-07-30): version bump for HTML/GAS/SW lockstep -- Approvals + Payroll picker identity display fixes, see HTML CACHE changelog; no SW/caching-strategy change itself. // v454_ess-fixattendance-whitelist-fix (2026-07-30): version bump for HTML/GAS/SW lockstep -- GAS-only ESS whitelist fix, see GAS HRMS_VERSION changelog; no SW/caching-strategy change itself. // v453_daybyday-slipdownload-diagnostic-fix (2026-07-30): version bump for HTML/GAS/SW lockstep -- fixed the single-slip download's day-by-day table silently showing nothing with no reason (HTML-only, see HTML CACHE changelog); no SW/caching-strategy change itself. // v452_bulkattendance-late-ot-parity (2026-07-30): version bump for HTML/GAS/SW lockstep -- bulk/backfilled attendance entries now get lateMinutes + otMinutes computed the same way a live kiosk punch does (GAS-only fix, see GAS HRMS_VERSION changelog); no SW/caching-strategy change itself. // v451_devicenaming-daybyday-loudfailure-fix // v447_slip-spacing-pagefit-fix
