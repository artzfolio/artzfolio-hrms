...
const CACHE = 'artzfolio-hrms-v555-2026-08-10'; // v555: marker-only bump for 4-way lockstep (ExitForm_Clauses client fast-read; 5 other Tier-2 candidates deliberately deferred with documented reasons; stale JWT doc comment fixed; SW itself unchanged).
