...
const CACHE = 'artzfolio-hrms-v560-2026-08-12'; // v560: marker-only bump for 4-way lockstep (FnF employee-search State.employees fix; SW file content itself unchanged).
