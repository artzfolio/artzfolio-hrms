...
const CACHE = 'artzfolio-hrms-v452-2026-07-30'; // v452_bulkattendance-late-ot-parity (2026-07-30): version bump for HTML/GAS/SW lockstep -- bulk/backfilled attendance entries now get lateMinutes + otMinutes computed the same way a live kiosk punch does (GAS-only fix, see GAS HRMS_VERSION changelog); no SW/caching-strategy change itself. // v451_devicenaming-daybyday-loudfailure-fix // v447_slip-spacing-pagefit-fix
