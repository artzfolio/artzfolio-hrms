// ArtzFolio HRMS — Service Worker (v154)
...
const CACHE = 'artzfolio-hrms-v154-2026-06'; // v150: bumped so every device drops the stale shell and pulls the T&C-kiosk-gate + FnF-notice + freeze-pane build
