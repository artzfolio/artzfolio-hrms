...
const CACHE = 'artzfolio-hrms-v561-2026-08-12'; // v561: marker-only bump for 4-way lockstep (FnF advance-recovery double-count fix + Auto-UL client-side chunking; SW file content itself unchanged).
