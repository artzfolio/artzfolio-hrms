...
const CACHE = 'artzfolio-hrms-v413-2026-07-18'; // v413 (2026-07-18): version bump only, for HTML/GAS/SW 4-way lockstep — ESS "My Dashboard" face login now works off EITHER enrolled face store (on-device descriptor OR AWS Cloud Face), mirroring the kiosk's own local-then-cloud order (GAS-only logic change; no SW/caching-strategy change).
