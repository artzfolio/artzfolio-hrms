...
const CACHE = 'artzfolio-hrms-v182-2026-06'; // v165: bumped (v164->v165) so every device drops the stale shell and pulls the PDF margins + identity-font + employee-filters + OT-discoverability build
