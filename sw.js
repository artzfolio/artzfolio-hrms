...
const CACHE = 'artzfolio-hrms-v412-2026-07-18'; // v412 (2026-07-18): version bump only, for HTML/GAS/SW 4-way lockstep — Approvals Inbox identity-card fix + Add Transaction modal tooltip clip fix (both HTML-only, no SW logic change).
