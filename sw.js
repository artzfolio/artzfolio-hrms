// ArtzFolio HRMS — Service Worker (v155)
...
const CACHE = 'artzfolio-hrms-v155-2026-06'; // v150: bumped so every device drops the stale shell and pulls the T&C-kiosk-gate + FnF-notice + freeze-pane build
