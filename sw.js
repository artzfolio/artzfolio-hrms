// ArtzFolio HRMS — Service Worker · cache key artzfolio-hrms-v512-2026-08-05
...
const CACHE = 'artzfolio-hrms-v523-2026-08-07'; // v523: boot-load deferred-activities perf fix (HTML-only) -- // v522: HTML-only critical fix -- employee salary fast-path bug (see HTML/GAS changelog). // v521: backupSyncTick time-boxed (5min) + resumable cursor -- GAS-only, no SW/caching-shape change.
