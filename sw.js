// ArtzFolio HRMS — Service Worker (v152)
...
const CACHE = 'artzfolio-hrms-v152-2026-06'; // v150: bumped so every device drops the stale shell and pulls the T&C-kiosk-gate + FnF-notice + freeze-pane build
