...
const CACHE = 'artzfolio-hrms-v419-2026-07-20'; // v419 (2026-07-20): version bump for HTML/GAS/SW lockstep — new restricted "Kiosk" access mode (shared onboarding-PIN login -> role 'kiosk', limited to Quick Add Employee + Photo Scanning only; salary/bank fields never returned to kiosk sessions). No SW/caching-strategy change, no engine change.
