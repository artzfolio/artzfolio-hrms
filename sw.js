...
const CACHE = 'artzfolio-hrms-v564-2026-08-12'; // v564: marker-only bump for 4-way lockstep (_v303TwoPhase bottom-fallback retry fix; SW file content itself unchanged).
