...
const CACHE = 'artzfolio-hrms-v562-2026-08-12'; // v562: marker-only bump for 4-way lockstep (congestion-resilience round -- _v303TwoPhase + _v426GetEmployeesCached stale-cache fallbacks, punch-drain stagger; SW file content itself unchanged).
