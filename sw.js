...
const CACHE = 'artzfolio-hrms-v532-2026-08-09'; // v530: marker-only bump for 4-way lockstep -- stale "40 tables" Settings text corrected to 46, HTML-only. -- // v529: marker-only bump for 4-way lockstep -- 'PulseQuestions'+'PulseResponses' added to the GAS-side nightly backup mirror, no SW/HTML change. -- // v528: marker-only bump for 4-way lockstep -- 'Assets' added to the GAS-side nightly backup mirror, no SW/HTML change. -- // v527: marker-only bump for 4-way lockstep -- 'Candidates'+'OfferLetters' added to the GAS-side nightly backup mirror, no SW/HTML change. -- // v526: marker-only bump for 4-way lockstep -- 'Tickets' added to the GAS-side nightly backup mirror, no SW/HTML change. -- // v525: marker-only bump for 4-way lockstep -- HTML/GAS gained one owner-only "Run Full RLS Test (Leaves pilot)" button, no SW change. -- // v524: marker-only bump for 4-way lockstep -- HTML gained anew owner-only "Test Supabase JWT Mint" diagnostic button + JS function, GAS gained the mintTestSupabaseJwt handler; no SW/caching-shape change. -- // v523: boot-load deferred-activities perf fix (HTML-only) -- // v522: HTML-only critical fix -- employee salary fast-path bug (see HTML/GAS changelog). // v521: backupSyncTick time-boxed (5min) + resumable cursor -- GAS-only, no SW/caching-shape change.
